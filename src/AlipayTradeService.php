...
require __DIR__ . DIRECTORY_SEPARATOR . 'aop' . DIRECTORY_SEPARATOR . 'request' . DIRECTORY_SEPARATOR . 'AlipayTradeQueryRequest.php';
require __DIR__ . DIRECTORY_SEPARATOR . 'aop' . DIRECTORY_SEPARATOR . 'request' . DIRECTORY_SEPARATOR . 'AlipayTradeRefundRequest.php';
require __DIR__ . DIRECTORY_SEPARATOR . 'aop' . DIRECTORY_SEPARATOR . 'request' . DIRECTORY_SEPARATOR . 'AlipayTradeCloseRequest.php';
require __DIR__ . DIRECTORY_SEPARATOR . 'aop' . DIRECTORY_SEPARATOR . 'request' . DIRECTORY_SEPARATOR . 'AlipayTradeFastpayRefundQueryRequest.php';
require __DIR__ . DIRECTORY_SEPARATOR . 'aop' . DIRECTORY_SEPARATOR . 'request' . DIRECTORY_SEPARATOR . 'AlipayDataDataserviceBillDownloadurlQueryRequest.php';
...
class AlipayTradeService {
	...
	function __construct($alipay_config){
		...
		$this->debug=$alipay_config['debug'];
	...
	function writeLog($text) {
		...
		//$text = characet ( $text );
        if ($this->debug) {
            file_put_contents('/tmp/zlog_for_alipay_trade_service_debug_str.log', date('Y-m-d H:i:s') . '--' . $text . "\n", FILE_APPEND);
        }
	}
